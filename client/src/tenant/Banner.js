...
import { Box, Flex, Heading, Text, Image, IconButton, Container } from "@chakra-ui/react";
...
const Banner = () => {
  ...
  const handleImageTransition = () => {
    return currentImageIndex === bannerImages.length - 1 ? 0 : currentImageIndex + 1;
  };
           ...
           <AnimatePresence mode='wait'>
            ...
            >
              <Image 
                ...
                h="100%"
                objectFit="cover"
                borderRadius={{ base: "90px 10px 90px 10px", lg: "90px 10px 90px 10px" }} // Bo góc trên bên trái và dưới bên phải
